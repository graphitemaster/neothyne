...
struct Instr {
    ...
    enum {
        ...
        kBranch,
        kTestBranch,
        // The following instructions are generated by optimizations only
        kAccessKey,
        kAssignKey
    };
...
// Only generated during optimization passes
struct AccessKeyInstr : Instr {
    Slot m_targetSlot;
    Slot m_objectSlot;
    const char *m_key;
};

struct AssignKeyInstr : Instr {
    Slot m_objectSlot;
    Slot m_valueSlot;
    const char *m_key;
    AssignType m_assignType;
