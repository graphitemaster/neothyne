Neothyne comes with a fairly straight forward editing mode for placing entities
in the world. The mode can be entered via 'E'.

Inside edit mode you can click on any visible entity to edit it's properties
...
Moving entities can be acomplished by clicking and dragging the entity around
while flying.
