// File automatically generated by r_generator.cpp
...
#   define GL_CHECK_1(SPEC, ...) debugCheck(SPEC, __func__, file, line, __VA_ARGS__)
#else
#   define GL_CHECK_0(...)
#   define GL_CHECK_1(...)
#endif

// Map GL_CHECK to the right thing
#define PP_PHELP(X, Y) \
   X ## Y
#define PP_PASTE(X, Y) \
   PP_PHELP(X, Y)
...
// OpenGL debugging
    ...
    u::string stringize<'*', void *>(void *value, char base) {
        if (base == '?')
            ...
            return u::format("GLvoid*=%p", value);
        else if (base == '2')
            return u::format("GLenum*=%p", value);
        else if (base == '3')
            return u::format("GLboolean*=%p", value);
        else if (base == '4')
            return u::format("GLbitfield*=%p", value);
        else if (base == '5')
            return u::format("GLbyte*=%p", value);
        else if (base == '6')
            return u::format("GLshort*=%p", value);
        else if (base == '7')
            return u::format("GLint*=%p", value);
        else if (base == '8')
            return u::format("GLsizei*=%p", value);
        else if (base == '9')
            return u::format("GLubyte*=%p", value);
        else if (base == 'a')
            return u::format("GLushort*=%p", value);
        else if (base == 'b')
            return u::format("GLuint*=%p", value);
        else if (base == 'c')
            return u::format("GLfloat*=%p", value);
        else if (base == 'd')
            return u::format("GLclampf*=%p", value);
        else if (base == 'e')
            return u::format("GLintptr*=%p", value);
        else if (base == 'f')
            return u::format("GLsizeiptr*=%p", value);
